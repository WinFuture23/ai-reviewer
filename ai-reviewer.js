/**
 * wfv4_model_aireviewer — AI-powered article review widget for WinFuture.de.
 *
...
(function() {
    ...
    const wfv4_link_preview = (() => {
        ...
        function show( url, x, y ) {
            ...
            const mod_delta = data.published_time && data.modified_time
                ? (new Date( data.modified_time ) - new Date( data.published_time )) / 3600000 : 0;
            let date_html = '';
            if (pub) {
